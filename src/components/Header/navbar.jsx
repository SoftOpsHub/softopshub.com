...
import { FaChevronDown, FaCloud, FaCode, FaCube, FaServer, FaChalkboardTeacher, FaTools } from 'react-icons/fa';
                  ...
                  >
                    <div className="max-w-7xl mx-auto px-6 lg:px-8 py-6 grid grid-cols-3 gap-6">
                      <div>
                        ...
                        <a href="/services/cloudDevops" className=" px-4 py-2 hover:bg-gray-100 flex items-center">
                          <FaCloud className="mr-2 text-gray-500" /> Cloud & DevOps
                        </a>
                        <a href="/fullstack" className=" px-4 py-2 hover:bg-gray-100 flex items-center">
                          <FaCode className="mr-2 text-gray-500" /> Full Stack Development
                        </a>
                        <a href="/web3" className=" px-4 py-2 hover:bg-gray-100 flex items-center">
                          <FaCube className="mr-2 text-gray-500" /> Web3 Services
                        </a>
                        <a href="/infrastructure" className=" px-4 py-2 hover:bg-gray-100 flex items-center">
                          <FaServer className="mr-2 text-gray-500" /> IaC (Infrastructure as Code)
                        </a>
                      </div>
                      <div>
                        <h3 className="font-extrabold text-green-700">More</h3>
                        <a href="/consulting" className=" px-4 py-2 hover:bg-gray-100 flex items-center">
                          <FaChalkboardTeacher className="mr-2 text-gray-500" /> Consulting
                        </a>
                        <a href="/training" className=" px-4 py-2 hover:bg-gray-100 flex items-center">
                          <FaTools className="mr-2 text-gray-500" /> Training
                        </a>
                        <a href="/pipelines" className=" px-4 py-2 hover:bg-gray-100 flex items-center">
                          <FaServer className="mr-2 text-gray-500" /> CI/CD Automation
                        </a>
                      </div>
                      <div className="flex flex-col items-center bg-gray-100 p-3 rounded-md">
                        ...
                        <a href="/services" className="mt-2 text-gray-500 hover:underline">Get started →</a>
                      </div>
                    </div>
                  </motion.div>
                )}

...
import { FaMagic, FaCloud, FaLaptopCode, FaEthereum, FaPencilRuler, FaCheckCircle } from "react-icons/fa";

const ServiceBanner = () => {
  return (
    <div className= "bg-gradient-to-r from-blue-500 to-orange-600 text-white py-16 px-6 text-center shadow-lg">
...
const ServicesGrid = () => {
  const services = [
    { title: "Cloud Computing", description: "Modernize Cloud applications, infrastructure and operations.", icon: <FaCloud className="text-4xl text-orange-600" />, bg: "bg-orange-100" },
    { title: "Full Stack Development", description: "Build highly interactive and scalable web applications.", icon: <FaLaptopCode className="text-4xl text-red-600" />, bg: "bg-red-100" },
    { title: "Web3 Services", description: "Develop decentralized applications and blockchain solutions.", icon: <FaEthereum className="text-4xl text-purple-600" />, bg: "bg-purple-100" },
